...
/**
 * @file  mod_status_json.h
 * @brief Status Report Extension Module to Apache
 *
 * @defgroup MOD_STATUS_JSON mod_status_json
 * @ingroup  APACHE_MODS
 * @{
 */

#ifndef MOD_STATUS_JSON_H
#define MOD_STATUS_JSON_H
...
/* Optional hooks which can insert extra content into the mod_status_json
